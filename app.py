...
def apply_intelligent_rules(text):
    ...
    # උදා: "මම නල්." -> "මගේ නම නල්."
    # RegEx රටාව: "මම " වලින් පටන් ගෙන, ඊළඟට වචනයක් තියෙනවා නම්
    pattern = r"^මම\s+([\w\']+)\.?$"
    ...
    # තවත් බුද්ධිමත් රීති මෙතනට එකතු කළ හැක...

    return text # කිසිම රීතියකට ගැලපෙන්නේ නැත්නම්, මුල් text එකම ආපසු යවයි
    ...
    try:
        ...
        for i, block in enumerate(blocks):
            ...
            if len(lines) > 1:
                ...
                # දෙබසේ හැම පේළියකටම මේ රීති යොදන්න ඕන
